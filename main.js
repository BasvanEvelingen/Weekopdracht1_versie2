...
// content laden in twee targets succesievelijk
function loadText(target, textfile, target2, textfile2) {
    ...
    file.onload = function() {
        if (file.readyState === 4 && file.status === 200) {  // bestand gevonden en klaar om aan html gevoerd te worden.
            ...
            // als alleen eerste geladen is, functie recursief starten met null parameters voor de tweede.
            if (target2!=null && textfile2 !=null)
            {
                loadText(target2, textfile2,null,null);
            }
